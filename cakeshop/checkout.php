...
<html lang="en">
  <head>
    ...
    <title>Dolphin Bakery | Checkout</title>
  ...
  <div class="container">
    ...
    <main>
      ...
      <div class="py-5 text-center">
        <h1 class="business-name">Dolphin Bakery</h1>
        <h2>Checkout Page</h2>
      </div>
          ...
          <div class="row g-3">
              ...
              <div class="col-md-4">
                ...
                <select class="form-select" name="city" id="state" required>
                  <option value="Chennai">Kurnool</option>
                  <option value="Kanchipuram">Kanchipuram</option>
                  <option value="Coimbatore">Coimbatore</option>
                  <option value="Tiruchirapalli">Hyderabad</option>
                  <option value="Salem">Chennai</option>
