...
<div id="contact-submission" class="contact-section">
    <div class="contact-us">
        <div class="subtitle">
            <h2>Contact Us</h2>
            <p>
In 2000, Dolphin Bakery was established. From the moment our first cake went into the oven, we have operated with a simple vision: of creating fresh, delicious, innovative products. We considered them our 'prized pastries'.
