...
<header class="<?php if($page == 'index' || $page == 'products'){echo 'indexNav';}?> main-header-media1200">
    <nav class="nav-media1200 main-nav-media1200">
        ...
        <h1 class="business-name-media1200"><a href="index.php" class="animate__animated animate__backInDown">Dolphin Bakery</a></h1>
        ...
        <ul class="animate__animated animate__backInDown">
            ...
            <li><a href="makeyourcake.php" class="<?php if($page == 'makeyourcake'){echo 'active';}?>">MAKEYOURCAKE</a></li>
