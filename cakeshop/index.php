...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>Dolphin Bakery | Home</title>
        ...
        <section class="offer-section">
            <div class="offer-bg">
                <div class="offer-data">
                    ...
                    <p class="offer-description">Extreme Independence Day Sales ends in: </p>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper0">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Ms. Aisha Royal</b></p>
